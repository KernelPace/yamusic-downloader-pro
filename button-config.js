...
// ИСПОЛЬЗУЕМ var, ЧТОБЫ ПЕРЕМЕННАЯ БЫЛА ВИДНА В content.js в FIREFOX
var YM_DL_BUTTON_CONFIG = Object.freeze({
  states: ICONS,
  selectors: {
  ...
  buttons: {
    trackList: { className: 'ym-dl-btn-list', title: 'Скачать MP3', style: { ...baseStyle, width: '18px', height: '18px', padding: '0', marginLeft: '8px', opacity: '0.6', verticalAlign: 'middle', position: 'relative' } },
    playerBar: { className: 'ym-dl-btn-player', title: 'Скачать текущий трек', style: { ...baseStyle, width: '46px', height: '46px', margin: '0 12px', background: 'rgba(255, 255, 255, 0.08)', borderRadius: '50%', border: '1px solid rgba(255, 255, 255, 0.1)', opacity: '0.8', zIndex: '99999' } },
    sidebarButton: { className: 'ym-dl-btn-sidebar', title: 'Скачать MP3', style: { ...baseStyle, width: '36px', height: '36px', margin: '0 8px', background: 'rgba(255, 255, 255, 0.08)', borderRadius: '50%', border: '1px solid rgba(255, 255, 255, 0.1)', opacity: '0.9' } },
    pageButton: { className: 'ym-dl-btn-page', title: 'Скачать трек', style: { ...baseStyle, padding: '10px 20px', background: 'rgba(255,255,255,0.05)', borderRadius: '8px', border: '1px solid rgba(255,255,255,0.1)', color: 'inherit', gap: '8px' } }
  }
});